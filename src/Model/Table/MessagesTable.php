...
class MessagesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->requirePresence('peerid', 'create')
            ->notEmptyString('peerid');

        $validator
            ->scalar('listing_slugpeerid')
            ->maxLength('listing_slugpeerid', 255)
            ->requirePresence('listing_slugpeerid', 'create')
            ->notEmptyString('listing_slugpeerid');
